...
public class mainfortoot extends Application {
   ...
   // public SimpleObjectProperty<Text> playerTextProperty = new SimpleObjectProperty<Text>("T");
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("JavaFX TOOT_2");
            	...
            	diskPreview.setOnMouseClicked(new EventHandler<MouseEvent>(){
                    ...
                    public void handle(MouseEvent arg0) {
                    	...
                    	*/
                            ...
                            ////toot加上去的
                            	if(toot == "T") {
                            		multi[rowIndex][colIndex] = 3;
                            	}else if(toot == "O") {
                            		multi[rowIndex][colIndex] = 4;
                            	}
                            ////toot加上去的
                            	///multi[rowIndex][colIndex] = 2;
                    ...
                    public void handle(MouseEvent arg0) {
                    	...
                    	//red is person,yellow is AI
                            ...
                            if(playerColorProperty.get()==Color.RED){
                             ...
                             //   disk.setFill(Color.YELLOW);
                                int AIindex = randomaitoot.position(multi);
                                int AIletter = randomaitoot.letter();
                                int AIrow = AIindex/c;
                                int AIcol = AIindex%c;
                                AIregretRow = AIrow;
                                AIregretCol = AIcol;
                                ...
                                if(AIdisk.getTranslateY()!=0){
                                    ...
                                    boolean AIredWin = tootwinner.redWinTOOT(multi);
                                	boolean AIyellowWin = tootwinner.yellowWinOTTO(multi);
