...
public class simpletootwinner {
	public static int[][] multi = simpletoot.multi;
	...
	public static boolean yellowWinOTTO(int[][] multi) {
        ...
        for(int i=r-1;i>=0;--i){
            for(int j=0;j<=c-1;++j){
                ...
                //Checking cells to the right
                if(j<=c-4){
                            if(multi[i][j] == 2&&multi[i][j+1] == 1&&
                            		multi[i][j+2] == 1&&multi[i][j+3] == 2) {
                            	flag = true;
                            	return flag;
                            }  
                ...
                //Checking cells up
                if(i>=3){
                	if(multi[i][j] == 2&&multi[i-1][j] == 1&&
                    		multi[i-2][j] == 1&&multi[i-3][j] == 2) {
                    	flag = true;
                    	return flag;
                    }  
                ...
                //Checking diagonal up-right
                if(j<=c-4 && i>=3){
                	if(multi[i][j] == 2&&multi[i-1][j+1] == 1&&
                    		multi[i-2][j+2] == 1&&multi[i-3][j+3] == 2) {
                    	flag = true;
                    	return flag;
                    }  
